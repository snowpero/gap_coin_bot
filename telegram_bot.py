...
# 봇 토큰, 봇 API 주소
TOKEN = '593713397:AAHJ82B7ychTDqAiLDXher1Bcv2C_4Igm1A'
...
app = webapp2.WSGIApplication([
    ('/telegram_bot/me', MeHandler),
    ('/telegram_bot/updates', GetUpdatesHandler),
    ('/telegram_bot/set-webhook', SetWebhookHandler),
    ('/telegram_bot/webhook', WebhookHandler),
], debug=True)
